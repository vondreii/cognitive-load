...
public class TerrainManager : MonoBehaviour
{
    ...
    void endGame(float currentTime)
    {
        ...
        //File.AppendAllText(filePath, " --> Total number of times crashed: " + carbehaviour.getTimesCrashed());
        //File.AppendAllText(filePath, " --> Total Points: " + carbehaviour.getPoints());
    ...
    void spawnCars(float offset, int distance)
    {
        ...
        if (car != null)
        {
            ...
            if (!randomCarName.Equals("RoadBlock01"))
            {
                ...
                fileManagement.saveCarSpawnedDetails("1", spawnCarX, spawnCarY, spawnCarZ, "0", "0", "0");
            }
        }
    }
