...
public class TerrainManager : MonoBehaviour
{
    ...
    public void manageDifficulty(Boolean responded, float responseTime)
    {
        ...
        if (WMA > 0)
        {
            // Counts how many times their moving average is greater than the critical point
            if (WMA > baseline.getCritPoint()) critPointCounter++; 
            else noCritPointCounter++;
            
            // If their moving average was less (two times) (i.e., they are responding slower) the difficulty decreases.
            ...
            // Otherwise, if their moving average is greater than the critical point (two times)
			// (i.e., they are consistently doing well) the difficulty will increase.
